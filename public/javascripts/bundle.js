...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"recommend.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(user, url, title, descr, postId) {
    var res, bodyFormData, res2;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"editpost.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"image.js":[function(require,module,exports) {
"use strict";
...
var deletePostButton = document.querySelectorAll('.btn-delete-post');
...
if (headeruserimg) {
  headeruserimg.onload = function () {
    console.log("Image loaded, size ".concat(headeruserimg.src));
  };
...
if (accountuserimg) {
  accountuserimg.onload = function () {
    console.log("Image loaded, size ".concat(accountuserimg.src));
  };
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(username, email, password, passwordconfirm);
  });
}
...
if (deletePostButton) {
  var _loop = function _loop(i) {
    deletePostButton[i].addEventListener('click', function () {
      var postId = document.getElementById("post-id-".concat(i)).textContent;
      (0, _editpost.deletePost)(postId);
    });
  };

  for (var i = 0; i < deletePostButton.length; i++) {
    _loop(i);
  }
}
...
if (contributeButton) {
  contributeButton.addEventListener('click', function () {
    var info = confirm("1. Please ensure you want to upload your browsing history \n2. Ensure that you are the owner of the history");

    if (info === true) {
      var txt = "Thanks your contribution.";
      (0, _contribute.contribute)();
      (0, _alert.showAlert)('success', txt);
    } else {
      var _txt = "It's ok. You can still use recommend service !!";
      (0, _alert.showAlert)('warn', _txt);
...
if (searchButton) {
  searchButton.addEventListener('click', function (e) {
    ...
    var postId = document.getElementById('post-id').textContent;
